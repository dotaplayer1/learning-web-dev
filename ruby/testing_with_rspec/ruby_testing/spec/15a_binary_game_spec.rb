  ...
  describe '#player_input' do
    ...
    context 'when user inputs an incorrect value once, then a valid input' do
      before do
        input_no1 = "@"
        input_no2 = "5"
        allow(game_input).to receive(:gets).and_return(input_no1, input_no2)
      end
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        ...
        input_no2 = "@"
        input_no3 = "2"
        allow(game_input).to receive(:gets).and_return(input_no1, input_no2, input_no3)
      end
  ...
  describe '#verify_input' do
    ...
    context 'when given a valid input as argument' do
      it 'returns valid input' do
        ...
        expect(verify_input_game.verify_input(min, max, valid_input)).to eql(valid_input)
      end
    end
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        ...
        min = verify_input_game.instance_variable_get(:@minimum)
        max = verify_input_game.instance_variable_get(:@maximum)
        expect(verify_input_game.verify_input(min, max, invalid_input)).to eql(nil)
      end
    end
  end
